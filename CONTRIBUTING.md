Contributing to ISLAMIC DIGITAL COIN
============================

The ISLAMIC DIGITAL COIN project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to islamic_digital_coin-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the islamic_digital_coin unit tests or QA tests
...
[Translation Process](https://github.com/islamic_digital_coin-project/islamic_digital_coin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ISLAMIC DIGITAL COIN project, and is not to be
confused with overall ISLAMIC_DIGITAL_COIN Network Protocol consensus changes.

Whether a pull request is merged into ISLAMIC DIGITAL COIN rests with the project merge
...
Patches that change ISLAMIC_DIGITAL_COIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the ISLAMIC_DIGITAL_COIN consensus, it must have been
...
The project leader is the release manager for each ISLAMIC DIGITAL COIN release.
