...
#include "qt/islamic_digital_coin/txviewholder.h"
#include "qt/islamic_digital_coin/tooltipmenu.h"
#include "qt/islamic_digital_coin/sendmultirow.h"
#include "qt/islamic_digital_coin/coldstakingmodel.h"
#include "qt/islamic_digital_coin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(ISLAMIC_DIGITAL_COINGUI* parent);
    ~ColdStakingWidget();
