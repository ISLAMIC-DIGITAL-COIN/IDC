...
#include "qt/islamic_digital_coin/sendcustomfeedialog.h"
#include "qt/islamic_digital_coin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ISLAMIC_DIGITAL_COINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ISLAMIC_DIGITAL_COINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
