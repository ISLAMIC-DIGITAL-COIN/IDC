...
#include <QWidget>
#include <QString>
#include "qt/islamic_digital_coin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(ISLAMIC_DIGITAL_COINGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    ISLAMIC_DIGITAL_COINGUI* getWindow() { return this->window; }
