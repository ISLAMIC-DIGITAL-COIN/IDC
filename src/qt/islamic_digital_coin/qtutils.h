...
void closeDialog(QDialog* widget, ISLAMIC_DIGITAL_COINGUI* gui);
void openDialogFullScreen(QWidget* parent, QWidget* dialog);
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ISLAMIC_DIGITAL_COINGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, ISLAMIC_DIGITAL_COINGUI* gui, double posX = 3);
bool openDialogWithOpaqueBackgroundFullScreen(QDialog* widget, ISLAMIC_DIGITAL_COINGUI* gui);
