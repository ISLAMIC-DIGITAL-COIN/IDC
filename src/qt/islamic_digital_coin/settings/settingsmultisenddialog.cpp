...
#include "qt/islamic_digital_coin/settings/forms/ui_settingsmultisenddialog.h"
                                                                    ...
                                                                    ui(new Ui::SettingsMultisendDialog)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText("ISLAMIC DIGITAL COIN address or contact label");
