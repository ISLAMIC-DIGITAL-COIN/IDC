...
#include "qt/islamic_digital_coin/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(ISLAMIC_DIGITAL_COINGUI* _window, QWidget *parent) :
