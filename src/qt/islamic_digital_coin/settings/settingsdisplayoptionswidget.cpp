...
#include "qt/islamic_digital_coin/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(ISLAMIC_DIGITAL_COINGUI* _window, QWidget *parent) :
