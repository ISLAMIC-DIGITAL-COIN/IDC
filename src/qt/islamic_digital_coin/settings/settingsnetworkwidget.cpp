...
#include "qt/islamic_digital_coin/settings/settingsnetworkwidget.h"
#include "qt/islamic_digital_coin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/islamic_digital_coin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ISLAMIC_DIGITAL_COINGUI* _window, QWidget *parent) :
