...
#include "qt/islamic_digital_coin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/islamic_digital_coin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ISLAMIC_DIGITAL_COINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ISLAMIC_DIGITAL_COINGUI::handleRestart()
