...
#include "qt/islamic_digital_coin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/islamic_digital_coin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ISLAMIC_DIGITAL_COINGUI* _window, QWidget *parent) :
