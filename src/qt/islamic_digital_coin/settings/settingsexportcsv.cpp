...
#include "qt/islamic_digital_coin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(ISLAMIC_DIGITAL_COINGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("ISLAMIC_DIGITAL_COIN_tx_csv_export(*.csv)") : tr("ISLAMIC_DIGITAL_COIN_addresses_csv_export(*.csv)"),
        nullptr);
