...
#include "qt/islamic_digital_coin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(ISLAMIC_DIGITAL_COINGUI* _window, QWidget *parent) :
