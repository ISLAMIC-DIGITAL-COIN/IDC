...
#include "qt/islamic_digital_coin/settings/forms/ui_settingsbackupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(ISLAMIC_DIGITAL_COINGUI* _window, QWidget *parent) :
