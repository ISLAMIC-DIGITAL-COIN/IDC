...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeislamic_digital_coinAmount") || reset)
        gArgs.SoftSetArg("-anonymizeislamic_digital_coinamount", settings.value("nAnonymizeislamic_digital_coinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in islamic_digital_coin.cpp during shotdown to also remove the window positions
