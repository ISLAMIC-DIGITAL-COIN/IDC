...
#include "qt/islamic_digital_coin/defaultdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ISLAMIC_DIGITAL_COINGUI* window = static_cast<ISLAMIC_DIGITAL_COINGUI*>(parentWidget());
...
{
    ISLAMIC_DIGITAL_COINGUI* gui = static_cast<ISLAMIC_DIGITAL_COINGUI*>(parentWidget());
...
{
    hide();
    static_cast<ISLAMIC_DIGITAL_COINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("ISLAMIC DIGITAL COIN will close now to finish the encryption process. "
