...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || gArgs.GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ISLAMIC DIGITAL COIN"),
     ...
     * override -datadir in the islamic_digital_coin.conf file in the default data directory
     * (to be consistent with islamic_digital_coind behavior)
     */
