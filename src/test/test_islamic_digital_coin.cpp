...
#define BOOST_TEST_MODULE islamic_digital_coin Test Suite
...
{
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_islamic_digital_coin_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
