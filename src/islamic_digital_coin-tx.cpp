...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("islamic digital coin islamic_digital_coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  islamic_digital_coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded islamic_digital_coin transaction") + "\n" +
                               "  islamic_digital_coin-tx [options] -create [commands]   " + _("Create hex-encoded islamic_digital_coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded islamic_digital_coin transaction
