...
The script [extract-osx-sdk.sh](https://github.com/islamic_digital_coin-project/islamic_digital_coin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
islamic_digital_coin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/islamic_digital_coin-project/islamic_digital_coin/blob/master/doc/README_osx.md) for troubleshooting tips.
