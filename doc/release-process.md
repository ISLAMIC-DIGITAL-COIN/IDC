...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/ISLAMIC-DIGITAL-COIN/IDC/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/ISLAMIC-DIGITAL-COIN/IDC/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/ISLAMIC-DIGITAL-COIN/IDC-detached-sigs.git
...
Build output expected:
  ...
  1. source tarball (`islamic_digital_coin-${VERSION}.tar.gz`)
...
- Detached signatures will then be committed to the [islamic_digital_coin-detached-sigs](https://github.com/ISLAMIC-DIGITAL-COIN/IDC-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/ISLAMIC-DIGITAL-COIN/IDC/releases/new) with a link to the archived release notes.
