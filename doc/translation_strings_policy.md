...
This document provides guidelines for internationalization of the ISLAMIC DIGITAL COIN software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to ISLAMIC_DIGITAL_COIN network</source>
        <translation>
            <numerusform>%n active connection to ISLAMIC_DIGITAL_COIN network</numerusform>
            <numerusform>%n active connections to ISLAMIC_DIGITAL_COIN network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `islamic_digital_coin_en.ts` remains unchanged.
