...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the islamic_digital_coin repository."
  exit 1
fi
...
echo
echo 'When compiling islamic_digital_coind, run `./configure` in the following way:'
echo
