...
class BlockIndexStatsTest(islamic_digital_coinTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 IDC "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 IDC + 9 notes of 5 IDC + 1 note of 4 IDC (using 1.0 fee)
