...
"""Verify that starting islamic_digital_coin with -h works as expected."""
import subprocess

from test_framework.test_framework import islamic_digital_coinTestFramework
from test_framework.util import assert_equal

class HelpTest(islamic_digital_coinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start islamic_digital_coin with -? for help text")
        ...
        self.log.info("Start islamic_digital_coin with -version for version information")
