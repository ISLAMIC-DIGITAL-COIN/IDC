...
- 1) start one islamic_digital_coind node from an pre-HD wallet wallet.dat file localized in util/data
...
class WalletUpgradeTest (islamic_digital_coinTestFramework):
