...
class ListReceivedTest (islamic_digital_coinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 IDC.
        ...
        # Send 1 IDC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 IDC sending them all (fee is 0.1 IDC)
        ...
        # Confirm transaction (2 IDC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 IDC, send 0.6 IDC + 0.05 IDC fee
