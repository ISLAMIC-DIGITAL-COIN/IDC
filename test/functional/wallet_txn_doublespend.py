...
class TxnMallTest(islamic_digital_coinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 6,250 IDC:
        ...
        # First: use raw transaction API to send 1240 * 5 IDC to node1_address,
        # but don't broadcast:
