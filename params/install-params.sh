...
function install_params {
    ...
    if ! [ -f "$filename" ]
    then
        filename="share/islamic_digital_coin/$filename"
    fi
...
function main() {
    ...
    cat <<EOF
ISLAMIC_DIGITAL_COIN - install-params.sh

This script will install the ISLAMIC_DIGITAL_COIN zkSNARK parameters and verify their
